    ...
    <div className="max-w-4xl space-y-6">
      <PageHeader
        ...
        helpContent={
          <div className="space-y-2">
            <p>
              {t('customers.helpContent')}
            </p>
            <p className="flex items-center gap-2">
              <ArrowRight className="h-4 w-4" style={{ color: 'var(--color-accent)' }} />
              <span dangerouslySetInnerHTML={{ __html: t('customers.helpNextStep') }} />
            </p>
          </div>
        }
        actions={
      ...
      {!hasCatalog && (
        ...
        >
          ...
          <div>
            ...
            <p className="text-sm" style={{ color: 'var(--color-text-secondary)' }} dangerouslySetInnerHTML={{ __html: t('customers.setupCatalogFirst.description') }} />
          </div>
        </div>
      )}
      ...
      {isLoading ? (
        ...
        <EmptyState
          ...
          tips={[
            t('customers.tips.tip1'),
            t('customers.tips.tip2'),
            t('customers.tips.tip3'),
          ]}
        />
      ) : (
          ...
          {customers.length > 0 && hasCatalog && (
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm" style={{ color: 'var(--color-text-secondary)' }} dangerouslySetInnerHTML={{ __html: t('customers.readyForSubscriptions.description') }} />
              </div>
            </div>
          )}
        </div>
