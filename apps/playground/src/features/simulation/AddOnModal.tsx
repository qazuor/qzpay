...
import { X, Package, Check, Loader2, Plus, Minus, AlertTriangle } from 'lucide-react';
import { useConfigStore } from '../../stores/config.store';
import { exportPlaygroundData } from '../../adapters/local-storage.adapter';
import type { QZPaySubscription, QZPayAddOn, QZPaySubscriptionAddOn } from '@qazuor/qzpay-core';
  ...
  useEffect(() => {
    ...
    const loadAddOns = async () => {
      try {
        ...
        const currentAddOns = subAddOns.filter(sa =>
          sa.subscriptionId === subscription.id && sa.status === 'active'
        );
    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-content max-w-lg" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-body space-y-4">
          ...
          {/* Quantity Selector */}
          {selectedAddOn && selectedAddOn.allowMultiple && (
            <div>
        ...
        <div className="modal-footer">
          ...
          <button
            ...
            disabled={!selectedAddOnId || isProcessing}
          >
            {isProcessing ? (
              <>
