...
import type { QZPayInvoice, QZPayCustomer } from '@qazuor/qzpay-core';
...
export function InvoicesView() {
  ...
  const loadData = async () => {
    ...
    setIsLoading(true);
    try {
      const [invoicesResult, custResult] = await Promise.all([
    ...
    <div className="max-w-4xl space-y-6">
      ...
      {isLoading ? (
        ...
        <EmptyState
          ...
          tips={[
            t('invoices.tips.tip1'),
            t('invoices.tips.tip2'),
            t('invoices.tips.tip3'),
          ]}
        />
      ) : (
