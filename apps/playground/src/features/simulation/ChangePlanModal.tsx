...
import type { QZPaySubscription, QZPayPrice } from '@qazuor/qzpay-core';
...
export function ChangePlanModal({
  ...
  const isUpgrade = selectedPrice && currentPrice
    ? selectedPrice.unitAmount > currentPrice.unitAmount
    : null;
  ...
  const formatAmount = (cents: number, curr: string = 'USD') => {
            ...
            {availablePlans.length === 0 ? (
              ...
              >
                <p style={{ color: 'var(--color-text-muted)' }}>
                  {t('subscriptions.changePlan.noOtherPlans')}
                </p>
              </div>
            ) : (
              ...
              <div className="space-y-1 text-sm">
                <div className="flex justify-between">
                  <span style={{ color: 'var(--color-text-muted)' }}>
                    {t('subscriptions.changePlan.unusedCredit')} ({prorationPreview.daysRemaining} {t('subscriptions.changePlan.days')})
                  </span>
                ...
                <div className="flex justify-between">
                  <span style={{ color: 'var(--color-text-muted)' }}>
                    {t('subscriptions.changePlan.newPlanCharge')}
                  </span>
                ...
                >
                  <span style={{ color: 'var(--color-text)' }}>
                    {t('subscriptions.changePlan.netAmount')}
                  </span>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-2">
                <button
                  ...
                  `}
                  style={{
                    backgroundColor: applyImmediately
                      ? 'var(--color-accent-low)'
                      : 'var(--color-surface)',
                    borderColor: applyImmediately
                      ? 'var(--color-accent)'
                      : 'var(--color-border)',
                  }}
                >
          ...
          {isUpgrade === false && (
            ...
            >
              ...
              <p className="text-sm text-yellow-500">
                {t('subscriptions.changePlan.downgradeWarning')}
              </p>
            </div>
          )}
