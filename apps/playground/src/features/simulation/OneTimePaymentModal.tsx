import type { QZPayCurrency, QZPayCustomer } from '@qazuor/qzpay-core';
import { DollarSign, PencilLine, ShoppingBag, X } from 'lucide-react';
/**
...
export function OneTimePaymentModal({ isOpen, onClose, preselectedCustomerId, onPaymentComplete }: OneTimePaymentModalProps) {
            ...
            <div className="modal-overlay" onClick={onClose}>
                <div className="modal-content max-w-lg" onClick={(e) => e.stopPropagation()}>
                            ...
                            <div>
                                ...
                                {activeProducts.length === 0 ? (
                                    ...
                                    >
                                        ...
                                        <p style={{ color: 'var(--color-text-muted)' }}>No products in catalog</p>
                                                ...
                                                style={{
                                                    backgroundColor:
                                                        selectedProductId === product.id
                                                            ...
                                                            : 'var(--color-surface)',
                                                    borderColor:
                                                        selectedProductId === product.id ? 'var(--color-accent)' : 'var(--color-border)'
                                                }}
                                            >
                        ...
                        {selectedCustomerId && paymentDetails.amount > 0 && (
                            <div className="p-3 rounded-lg space-y-2" style={{ backgroundColor: 'var(--color-surface-elevated)' }}>
                                <div className="flex justify-between items-center">
                                    ...
                                    <span style={{ color: 'var(--color-text)' }}>{selectedCustomer?.name || selectedCustomer?.email}</span>
                                </div>
                                <div className="flex justify-between items-center">
                                    <span style={{ color: 'var(--color-text-secondary)' }}>Item</span>
                                    <span style={{ color: 'var(--color-text)' }}>
                                        {paymentSource === 'catalog' && selectedProduct ? selectedProduct.name : 'Custom charge'}
                                    </span>
                                </div>
                                <div
                    ...
                    <div className="modal-footer">
                        ...
                        <button type="button" onClick={handleProceedToPayment} className="btn btn-primary" disabled={!canProceed()}>
