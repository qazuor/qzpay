...
export function SetupView() {
    ...
    return (
        <div className="max-w-4xl space-y-8">
                ...
                <div className="card p-4" style={{ backgroundColor: 'var(--color-accent-low)', borderColor: 'var(--color-accent)' }}>
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm" style={{ color: 'var(--color-text-secondary)' }}>
                                <SafeFormattedText text={t('firstTime.description')} />
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div data-tour="provider-selector" className="card p-6">
                <div className="flex items-center gap-2 mb-2">
                    ...
                    <HintIcon
                        title={tTour('tour.hints.provider.mock.title')}
                        content={tTour('tour.hints.provider.mock.content')}
                        position="right"
                    />
                </div>
              ...
              ${paymentMode === 'mock' ? 'ring-2' : 'hover:bg-[var(--color-surface-elevated)]'}
            `}
                        style={{
                    ...
                    >
                        ...
                        <div
                            ...
                            style={{ color: paymentMode === 'mock' ? 'var(--color-accent-high)' : 'var(--color-text)' }}
                        >
              ...
              ${paymentMode === 'stripe' ? 'ring-2 ring-purple-500' : 'hover:bg-[var(--color-surface-elevated)]'}
            `}
                        style={{
                    ...
                    <button
                        ...
                        className={`
              p-4 rounded-xl text-left transition-all duration-200
              ${paymentMode === 'mercadopago' ? 'ring-2 ring-cyan-500' : 'hover:bg-[var(--color-surface-elevated)]'}
            `}
                        style={{
                ...
                <div className="card p-6">
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <HintIcon
                            title={
                                paymentMode === 'stripe'
                                    ? tTour('tour.hints.provider.stripe.title')
                                    : tTour('tour.hints.provider.mercadopago.title')
                            }
                            content={
                                paymentMode === 'stripe'
                                    ? tTour('tour.hints.provider.stripe.content')
                                    : tTour('tour.hints.provider.mercadopago.content')
                            }
                            position="right"
                        />
                    </div>
                    ...
                    {paymentMode === 'stripe' && (
                        <div className="space-y-4">
                            ...
                            <div>
                                <label htmlFor="stripePublishableKey" className="label">
                                    {t('apiKeys.stripePublishable.label')}
                                </label>
                                <input
                                    ...
                                    placeholder={t('apiKeys.stripePublishable.placeholder')}
                                    className="input"
                                />
                                <p className="text-xs mt-2" style={{ color: 'var(--color-text-muted)' }}>
                                    {t('apiKeys.stripePublishable.help').split('<link>')[0]}
                                    <a
                                        href="https://dashboard.stripe.com/test/apikeys"
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        style={{ color: 'var(--color-accent)' }}
                                    >
                                        {t('apiKeys.stripePublishable.help').split('<link>')[1].split('</link>')[0]}
                                    </a>
                                    {t('apiKeys.stripePublishable.help').split('</link>')[1]}
                                </p>
                            </div>
                        </div>
                    )}
            ...
            {!isInitialized && (
                <div className="flex justify-center">
                    <button
                        ...
                        disabled={
                            (paymentMode === 'stripe' && (!stripeSecretKey || !stripePublishableKey)) ||
                            (paymentMode === 'mercadopago' && !mercadopagoAccessToken)
                        }
                ...
                <div className="card p-6" style={{ backgroundColor: 'var(--color-surface-elevated)' }}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <p className="font-medium" style={{ color: 'var(--color-text)' }}>
                                    {t('nextSteps.createCustomers.title')}
                                </p>
