...
import type { QZPayCurrency, QZPayBillingInterval } from '@qazuor/qzpay-core';
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              <input
                ...
                onChange={(e) => setSimulationConfig({ simulatedWebhookDelay: parseInt(e.target.value) })}
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              <input
                ...
                onChange={(e) => setSimulationConfig({ paymentFailureRate: parseInt(e.target.value) })}
                className="flex-1 h-2 bg-gray-700 rounded-lg appearance-none cursor-pointer accent-[var(--color-accent)]"
              />
      ...
      <div className="card p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            >
              {INTERVALS.map((i) => (
                <option key={i} value={i}>{t(`extendedConfig.defaults.billingInterval.options.${i}`)}</option>
              ))}
            </select>
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => setDefaultsConfig({ trialDays: parseInt(e.target.value) || 0 })}
              className="input"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => setDefaultsConfig({ invoiceDaysUntilDue: parseInt(e.target.value) || 30 })}
              className="input"
            />
          </div>
        </div>
