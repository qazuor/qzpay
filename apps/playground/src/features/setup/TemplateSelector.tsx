import { Briefcase, Code, Gift, Package, Check, Sparkles } from 'lucide-react';
import { useState } from 'react';
import { useTranslation } from 'react-i18next';
import { templates, type PlaygroundTemplate } from '../../data/templates';
import { importPlaygroundData, type PlaygroundData } from '../../adapters/local-storage.adapter';
              ...
              <div className="flex items-start gap-3">
                ...
                >
                  {isSelected && isLoading ? (
                    <div className="animate-spin h-5 w-5 border-2 border-current border-t-transparent rounded-full" style={{ color: 'var(--color-accent)' }} />
                  ) : isSelected ? (
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {!compact && (
                    <div className="flex flex-wrap gap-2 mt-2">
                      ...
                      {customerCount > 0 && (
                        <span className="badge text-xs" style={{ backgroundColor: 'var(--color-surface-elevated)' }}>
