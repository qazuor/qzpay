        ...
        <div className="max-w-4xl space-y-6">
                ...
                helpContent={
                    <div className="space-y-2">
                        ...
                        <p className="flex items-center gap-2">
                            ...
                            <span>
                                <SafeFormattedText text={t('prices.helpNextStep')} />
                            </span>
                        </p>
                    </div>
                }
                actions={
                    <button type="button" onClick={() => handleOpenModal()} className="btn btn-primary" disabled={plans.length === 0}>
            ...
            {plans.length === 0 ? (
                <EmptyState
                    ...
                    tips={[t('prices.tips.tip4'), t('prices.tips.tip5')]}
                />
            ) : prices.length === 0 ? (
                <EmptyState
                    icon={Tag}
                    ...
                    tips={[t('prices.tips.tip1'), t('prices.tips.tip2'), t('prices.tips.tip3')]}
                />
            ) : (
                        ...
                        >
                            ...
                            <div>
                                ...
                                <p className="text-sm" style={{ color: 'var(--color-text-secondary)' }}>
                                    <SafeFormattedText text={t('prices.catalogReady.description')} />
                                </p>
                            </div>
                        </div>
                    )}
                    ...
                    <div className="modal-content" onClick={(e) => e.stopPropagation()}>
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="modal-body space-y-4">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={(e) =>
                                                setFormData((prev) => ({ ...prev, unitAmount: Number.parseFloat(e.target.value) || 0 }))
                                            }
                                            className="input"
                                        />
                                        <p className="text-xs mt-1" style={{ color: 'var(--color-text-muted)' }}>
                                    ...
                                    <div>
                                        ...
                                        <select
                                            ...
                                            onChange={(e) =>
                                                setFormData((prev) => ({ ...prev, currency: e.target.value as QZPayCurrency }))
                                            }
                                            className="select"
                                        >
                                            {CURRENCIES.map((c) => (
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <select
                                            ...
                                            onChange={(e) =>
                                                setFormData((prev) => ({
                                                    ...prev,
                                                    billingInterval: e.target.value as QZPayBillingInterval
                                                }))
                                            }
                                            className="select"
                                        >
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={(e) =>
                                                setFormData((prev) => ({ ...prev, intervalCount: Number.parseInt(e.target.value) || 1 }))
                                            }
                                            className="input"
                                        />
                                        <p className="text-xs mt-1" style={{ color: 'var(--color-text-muted)' }}>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={(e) =>
                                            setFormData((prev) => ({ ...prev, trialDays: Number.parseInt(e.target.value) || 0 }))
                                        }
                                        className="input"
                                    />
                                    <p className="text-xs mt-1" style={{ color: 'var(--color-text-muted)' }}>
                            ...
                            <div className="modal-footer">
                                ...
                                <button type="submit" className="btn btn-primary" disabled={!formData.planId}>
