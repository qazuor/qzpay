...
export function AddonsView() {
    ...
    if (!isInitialized) {
        return <EmptyState icon={Package} title={t('addons.empty.title')} description={t('addons.empty.description')} />;
    }
        ...
        <div className="max-w-4xl space-y-6">
            <PageHeader
                ...
                helpContent={
                    <div className="space-y-2">
                        <p>{t('addons.helpContent')}</p>
                        <p className="text-sm" style={{ color: 'var(--color-text-muted)' }}>
                            <SafeFormattedText text={t('addons.helpExamples')} />
                        </p>
                    </div>
                }
                actions={
            ...
            {addons.length === 0 ? (
                <EmptyState
                    ...
                    tips={[t('addons.tips.tip1'), t('addons.tips.tip2'), t('addons.tips.tip3')]}
                />
            ) : (
                                ...
                                <div>
                                    ...
                                    <select
                                        ...
                                        onChange={(e) =>
                                            setFormData((prev) => ({
                                                ...prev,
                                                billingInterval: e.target.value as QZPayBillingInterval | 'one_time'
                                            }))
                                        }
                                        className="select"
                                    >
