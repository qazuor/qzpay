...
import { Edit2, Plus, ShoppingBag, Trash2, X } from 'lucide-react';
import { useEffect, useState } from 'react';
import { useTranslation } from 'react-i18next';
import { EmptyState } from '../../components/ui/EmptyState';
import { PageHeader } from '../../components/ui/PageHeader';
import { type ProductDefinition, useCatalogStore } from '../../stores/catalog.store';
            ...
            <PageHeader
                ...
                helpContent={
                    <div className="space-y-2">
                        <p>
                            {t(
                                'products.helpContent',
                                'Products are items for one-time payments. Use them for setup fees, consulting charges, or any non-recurring item.'
                            )}
                        </p>
                            ...
                            <div className="flex items-start justify-between">
                                <div className="flex-1">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="badge badge-primary">{formatAmount(product.unitAmount, product.currency)}</span>
