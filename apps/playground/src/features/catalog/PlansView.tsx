...
import { Edit2, LayoutGrid, Plus, Trash2, X, ArrowRight } from 'lucide-react';
        ...
        helpContent={
          <div className="space-y-2">
            ...
            <p className="flex items-center gap-2">
              ...
              <span dangerouslySetInnerHTML={{ __html: t('plans.helpNextStep') }} />
            </p>
          </div>
        }
        actions={
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-3">
                      ...
                      {priceCount === 0 && (
                        <span className="badge badge-warning">{t('plans.noPrices')}</span>
                      )}
                      {priceCount > 0 && (
            ...
            >
              ...
              <div>
                ...
                <p
                  ...
                  dangerouslySetInnerHTML={{ __html: t('plans.nextStepHint.description') }}
                />
              </div>
            </div>
          )}
