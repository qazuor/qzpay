...
export function WelcomePage({ onGetStarted, onNavigate }: WelcomePageProps) {
    const { t } = useTranslation('welcome');
    const { t: tTour } = useTranslation('tour');

    const handleStartTour = () => {
        // First dismiss welcome to show the main playground
        onGetStarted();

        // Start tour after a brief delay to let the UI render
        setTimeout(() => {
            startGuidedTour(tTour, {
                onNavigate: (view) => {
                    if (onNavigate) {
    ...
    return (
        <div className="min-h-screen overflow-auto" style={{ backgroundColor: 'var(--color-bg)' }}>
            ...
            <div className="max-w-5xl mx-auto px-6 py-16 text-center">
                ...
                <h1 className="text-4xl md:text-5xl font-bold mb-4 gradient-text">{t('hero.title')}</h1>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                    <button type="button" onClick={onGetStarted} className="btn btn-primary px-8 py-4 text-lg group">
                        {t('hero.getStarted')}
                ...
                <div className="relative">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="relative flex flex-col md:flex-row items-center gap-6">
                            ...
                            <div
                                className="hidden md:flex w-8 h-8 rounded-full items-center justify-center z-10"
            ...
            <div className="border-t py-6 text-center" style={{ borderColor: 'var(--color-border)' }}>
                <p className="text-sm" style={{ color: 'var(--color-text-muted)' }}>
                    {t('footer.partOf')}{' '}
                    <a
                        href="https://github.com/qazuor/qzpay"
                        target="_blank"
