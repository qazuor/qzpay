...
type DemoTab = 'overview' | 'pricing-table' | 'subscription-status' | 'invoice-list' | 'entitlement-gate' | 'limit-gate';
...
export function ComponentsView() {
    ...
    const renderOverview = () => (
        <div className="space-y-6">
            ...
            {/* Prerequisites */}
            {!hasData && (
                <div className="card p-4" style={{ backgroundColor: 'rgba(251, 191, 36, 0.1)', borderColor: 'rgba(251, 191, 36, 0.5)' }}>
