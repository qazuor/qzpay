 ...
 */
import type { QZPayBilling, QZPayBillingInterval, QZPayCurrency, QZPayEventMap } from '@qazuor/qzpay-core';
import { create } from 'zustand';
import { persist } from 'zustand/middleware';
import { checkBackendHealth, cleanupBackendSession, generateSessionId, initBackendSession } from '../lib/backend-client';
import { type PaymentMode, createPlaygroundBilling, resetBilling } from '../lib/billing';
        ...
        (set, get) => ({
            ...
            initializeBilling: async () => {
                ...
                try {
                    ...
                    const handleEvent = <K extends keyof QZPayEventMap>(eventType: K, payload: QZPayEventMap[K]) => {
                    ...
                    set({
                        ...
                        isInitialized: false,
                        isInitializing: false,
                        initError: error instanceof Error ? error.message : 'Failed to initialize billing'
                    });
                }
            },
