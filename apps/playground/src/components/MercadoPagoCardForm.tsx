...
export function MercadoPagoCardForm({
  ...
  const detectCardType = useCallback(async (number: string) => {
  ...
  }, [mpInstance, cardNumber, cardholderName, expirationDate, cvv, identificationType, identificationNumber, paymentMethodId, onTokenCreated, onError, onTokenizationComplete]);
