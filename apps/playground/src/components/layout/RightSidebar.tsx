import { Activity, CreditCard, Database, Users } from 'lucide-react';
...
const panelConfig: Record<
    PanelId,
    {
        icon: typeof Users;
        labelKey: string;
        // biome-ignore lint/suspicious/noExplicitAny: Panel components have varying props
...
export function RightSidebar({ currentView, activePanels }: RightSidebarProps) {
