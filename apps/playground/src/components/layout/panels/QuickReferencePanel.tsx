import { Check, Clock, Copy, CreditCard, DollarSign, FileText, Package, Settings, Shield, Sliders, Tag, Users } from 'lucide-react';
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="space-y-1 text-xs">
                            <div className="flex justify-between">
                                ...
                                <span
                                    style={{ color: simulation.autoProcessPayments ? 'var(--color-success)' : 'var(--color-text-muted)' }}
                                >
            ...
            <div>
                ...
                <div className="grid grid-cols-2 gap-1.5">
                    <div className="flex items-center gap-2 p-1.5 rounded text-xs" style={{ backgroundColor: 'var(--color-bg)' }}>
                        ...
                        <span className="ml-auto font-medium" style={{ color: 'var(--color-text)' }}>
                            {plans.length}
                        </span>
                    </div>
                    <div className="flex items-center gap-2 p-1.5 rounded text-xs" style={{ backgroundColor: 'var(--color-bg)' }}>
