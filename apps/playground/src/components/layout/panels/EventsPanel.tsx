...
import { Trash2, X, ChevronDown, ChevronRight, Activity, Download, Copy, Check } from 'lucide-react';
import {
  useEventsStore,
  getEventTypeColor,
  getEventTypeLabel,
                  ...
                  >
                    <div className="flex items-start gap-2">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="text-xs font-mono break-all" style={{ color: 'var(--color-text-secondary)' }}>
                          {getEntityId(event)}
                        </div>
                      </div>
                    </div>
