 ...
 */
export function createTestCustomer(overrides?: Partial<QZPayCustomer>): QZPayCustomer {
    const now = new Date();
    return {
 ...
 */
export function createTestSubscription(overrides?: Partial<QZPaySubscription>): QZPaySubscription {
    const now = new Date();
    ...
    return {
        ...
        planId: faker.helpers.arrayElement(['plan_starter_monthly', 'plan_pro_monthly', 'plan_enterprise_monthly']),
        status: 'active',
        interval: 'month',
        quantity: 1,
 ...
 */
export function createTestTrialSubscription(overrides?: Partial<QZPaySubscription>): QZPaySubscription {
    const now = new Date();
 ...
 */
export function createTestPayment(overrides?: Partial<QZPayPayment>): QZPayPayment {
    const now = new Date();
    return {
        id: faker.string.uuid(),
        customerId: faker.string.uuid(),
