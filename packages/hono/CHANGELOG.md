...
- 46cd67a: Fix `mapErrorToHttpStatus()` reporting a 500 INTERNAL_ERROR for deliberate rejections thrown by qzpay-core's typed error hierarchy (`QZPayValidationError`, `QZPayNotFoundError`, `QZPayConflictError`, `QZPayProviderSyncError`).
